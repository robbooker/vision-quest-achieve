...
import { LogOut, Settings, User, LayoutDashboard, CheckSquare, BarChart3, Star, Shield, RotateCcw, BookOpen, Target, Library, MessageSquarePlus, Plane, CalendarDays, TrendingUp, Hexagon, FileText, Sparkles, Sunrise } from 'lucide-react';
...
const dropdownNavItems = [
  ...
  { href: '/spiritual', label: 'Spiritual', icon: Sparkles },
