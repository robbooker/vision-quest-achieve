...
const tourSteps: Step[] = [
  ...
  },
  {
    ...
    disableBeacon: true,
    title: "Today",
    content: "Your daily execution view! Check off habits, view your calendar, and manage quick tasks - all in one crispy place.",
    data: { expression: "happy" },
  },
  {
  ...
  },
  {
    ...
    disableBeacon: true,
    title: "Settings",
    content: "Customize everything! Your vision, calendar sync, friends, and yes... Terminal mode for the power users. 💪",
    data: { expression: "thinking" },
  },
  {
